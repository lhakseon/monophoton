...
#include "postAnalyzer_WlnG_mc.h"
//#include "../weng/postAnalyzer_WlnG_mc.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "TH1F.h"
...
void postAnalyzer::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++)
  {
    ...
    phoCand   = getPhoCand(220,1.4442,1);
    phoCandUp   = getPhoCandUp(220,1.4442,1);
    phoCandDown   = getPhoCandDown(220,1.4442,1);
