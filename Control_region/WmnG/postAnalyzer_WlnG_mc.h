...
//   virtual void fillHistos(int histoNumber, double event_weight,int index,std::vector<int> jets,int lepindex_leading,int lepindex_subleading,Double_t dilepton_mass,Double_t dilepton_pt,Double_t leptoMET,Double_t leptoMET_phi);
  // virtual void fillHistos(int histoNumber, double event_weight,int index,std::vector<int> jets,int lepindex_leading,int lepindex_subleading,Double_t dilepton_mass,Double_t dilepton_pt,Float_t leptoMET_to_use,Float_t leptoMET_phi_to_use,Float_t MET_to_use,Float_t phoEt_to_use);
...
postAnalyzer::postAnalyzer(const char* file1, const char* file2)
{
  ...
  while ((filename = (TSystemFile*)next()) && fileNumber >  maxFiles)
    ...
    // TString dataset = "MC_ZLLGJets";
     TString dataset = "MC_";
 //    TString dataset = "MC_ZNuNuGJets_";
 //    TString dataset = "MC_ZLLGJets__PtG-130_";
//     TString dataset = "MC_WZ";
//     TString dataset = "MC_TTGJets_";
//     TString dataset = "MC_ZLLGJets_PtG-40to130_";
//     TString dataset = "MC_ZNuNuGJets_PtG-40to130_";
